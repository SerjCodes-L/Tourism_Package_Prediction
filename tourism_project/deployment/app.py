...
MonthlyIncome                   = st.number_input("Customer Monthly Income", 0, 999999, 10)
...
DurationOfPitch                 = st.number_input("Duration Of Pitch", 0, 300, 10)
PitchSatisfactionScore          = st.selectbox("Pitch Satisfaction Score",["1","2","3","4","5"])
NumberOfFollowups               = st.number_input("Number Of Followups", 0, 300, 10)
